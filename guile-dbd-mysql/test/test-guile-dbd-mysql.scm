...
-s
!#
;;; test-guile-dbd-mysql.scm - Unit tests for guile-dbd-mysql
;;;
;;; Copyright (C) 2026 Free Software Foundation, Inc.
;;;
;;; This file is part of the guile-dbd-mysql.
;;;
;;; The guile-dbd-mysql is free software; you can redistribute it and/or
...
;;;
;;; To run this test, you need a MySQL/MariaDB server running with a test database.
;;; Configure via environment variables:
;;;   DBI_TEST_MYUSER - MySQL username (default: "test")
;;;   DBI_TEST_MYPASS - MySQL password (default: "test")
;;;   DBI_TEST_MYDB   - MySQL database (default: "test")
;;;   DBI_TEST_MYHOST - MySQL host (default: "localhost")
;;;   DBI_TEST_MYPORT - MySQL port (default: "3306")
...
(define my-user (getenv-or "DBI_TEST_MYUSER" "test"))
(define my-pass (getenv-or "DBI_TEST_MYPASS" "test"))
(define my-db   (getenv-or "DBI_TEST_MYDB"   "test"))
(define my-host (getenv-or "DBI_TEST_MYHOST" "localhost"))
(define my-port (getenv-or "DBI_TEST_MYPORT" "3306"))

;; Connection string format: user:pass:db:tcp:host:port
(define conn-string
  (string-append my-user ":" my-pass ":" my-db ":tcp:" my-host ":" my-port))
...
(define db-obj (dbi-open "mysql" conn-string))
...
(if (not connected)
    (begin
      ...
      (newline)
      (display ";;; Skipping MySQL tests (no database available)")
      (newline)
      (exit 0)))
...
(display ";;; All MySQL tests completed")
(newline)
